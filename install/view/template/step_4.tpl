...
<div style="width: 100%; display: inline-block;">
	<div style="float: left; width: 569px;">
		<div class="warning">Don't forget to delete your installation directory! <a href="index.php?route=step_5">Click here</a> to attempt deletion of the install directory.</div>
		<p>Congratulations! You have successfully installed JSI-Cart.</p>
