		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			...
			<div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
				<table width="100%">
					...
					<tr>
						<td><?php echo $phpini_catalog; ?></td>
						<td><?php echo is_writable($phpini_catalog) ? '<span class="good">Writable</span>' : '<span class="bad">Unwritable</span>'; ?></td>
					</tr>
					<tr>
						<td><?php echo $phpini_admin; ?></td>
						<td><?php echo is_writable($phpini_admin) ? '<span class="good">Writable</span>' : '<span class="bad">Unwritable</span>'; ?></td>
					</tr>
				</table>
			</div>
