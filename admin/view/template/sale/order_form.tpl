...
<div class="box">
  ...
  <div class="heading">
    ...
    <div class="buttons"><a onclick="window.open('<?php echo $invoice; ?>');" class="button"><span><?php echo $button_invoice; ?></span></a><a onclick="window.open('<?php echo $packingslip; ?>');" class="button"><span><?php echo $button_packingslip; ?></span></a><a onclick="location='<?php echo $cancel; ?>';" class="button"><span><?php echo $button_back; ?></span></a></div>
  </div>
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div style="margin-bottom: 15px;">
        <div style="background: #547C96; color: #FFF; border-bottom: 1px solid #8EAEC3; padding: 5px; font-size: 14px; font-weight: bold;"><?php echo $text_split_order; ?></div>
        <div style="background: #FCFCFC; border: 1px solid #8EAEC3; padding: 10px;">
          <table class="list">
            <thead>
              <tr>
                <td class="left" width="25%"><b><?php echo $text_split_name; ?></b></td>
                <td class="left" width="25%"><b><?php echo $text_split_date; ?></b></td>
                <td class="left" width="25%"><b><?php echo $text_split_value; ?></b></td>
              </tr>
            </thead>
            <tbody>
              <tr>
      ...
      <div style="margin-bottom: 15px;">
        ...
        <div style="background: #FCFCFC; border: 1px solid #8EAEC3; padding: 10px;">
          <table class="list">
            ...
            <tbody>
              <tr>
                <td class="left"><a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a></td>
      ...
      <div style="margin-bottom: 15px;">
        ...
        <div style="background: #FCFCFC; border: 1px solid #8EAEC3; padding: 10px;">
          <table class="list">
            ...
            <thead>
              <tr>
                <td class="left" colspan="2"><b><?php echo $entry_tracking_info; ?></b></td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="left" colspan="2"><textarea name="tracking_info" cols="40" rows="2" style="width: 99%"><?php echo $tracking_info; ?></textarea></td>
              </tr>
            </tbody>
            <thead>
              <tr>
