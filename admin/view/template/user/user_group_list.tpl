...
<div class="box">
	...
	<div class="heading">
		...
		<div class="buttons"><?php if ($this->config->get('premium') === TRUE) { ?><a onclick="location='<?php echo $insert; ?>'" class="button"><span><?php echo $button_insert; ?></span></a><a onclick="$('form').submit();" class="button"><span><?php echo $button_delete; ?></span></a><?php } ?></div>
	</div>
	<div class="content">
