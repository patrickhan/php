				...
				<tr>
					...
					<td><div class="scrollbox" style="height:200px">
							...
							<div class="<?php echo $class; ?>">
								...
								<?php } else { ?>
								<?php if (in_array($permission, $access)) { ?>
								<input disabled type="checkbox" name="permission[access][]" value="<?php echo $permission; ?>" checked="checked" />
								<?php echo $permission; ?>
								<?php } else { ?>
								<input disabled type="checkbox" name="permission[access][]" value="<?php echo $permission; ?>" />
								<?php echo $permission; ?>
								<?php } ?>
								<?php } ?>
							</div>
				...
				<tr>
					...
					<td><div class="scrollbox" style="height:200px">
							...
							<div class="<?php echo $class; ?>">
								...
								<?php } else { ?>
								<?php if (in_array($permission, $modify)) { ?>
								<input disabled type="checkbox" name="permission[modify][]" value="<?php echo $permission; ?>" checked="checked" />
								<?php echo $permission; ?>
								<?php } else { ?>
								<input disabled type="checkbox" name="permission[modify][]" value="<?php echo $permission; ?>" />
								<?php echo $permission; ?>
								<?php } ?>
								<?php } ?>
							</div>
