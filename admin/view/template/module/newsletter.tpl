    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><select name="newsletter_status">
        ...
        <tr>
          ...
          <td><input type="text" name="newsletter_sort_order" value="<?php echo $newsletter_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
