    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><select name="switch_demo_position">
        ...
        <tr>
          ...
          <td><select name="switch_demo_status">
        ...
        <tr>
          ...
          <td><input type="text" name="switch_demo_sort_order" value="<?php echo $category_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
