...
<div class="box">
	...
	<div class="heading">
		...
		<div class="buttons"><a onclick="location='<?php echo $insert; ?>'" class="button"><span><?php echo $button_add_information; ?></span></a><a onclick="$('form').submit();" class="button"><span>Disable</span></a></div>
	</div>
	<div class="content">
