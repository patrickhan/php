        ...
        <tr>
          ...
          <td><div class="scrollbox">
              ...
              <div class="<?php echo $class; ?>">
                <?php if (in_array($album['album_id'], $image_album)) { ?>
                <input type="checkbox" name="image_album[]" value="<?php echo $album['album_id']; ?>" checked="checked" />
                <?php echo $album['name']; ?>
                <?php } else { ?>
                <input type="checkbox" name="image_album[]" value="<?php echo $album['album_id']; ?>" />
                <?php echo $album['name']; ?>
                <?php } ?>
              </div>
              <?php } ?>
