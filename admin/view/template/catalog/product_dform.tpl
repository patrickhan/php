			...
			<div id="tab_general">
				...
				<div id="language<?php echo $language['language_id']; ?>">
					<table class="form">
						...
						<input type="hidden" name="product_description[<?php echo $language['language_id']; ?>][meta_title_tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title_tag'] : ''; ?>" /><input type='hidden' name="product_description[<?php echo $language['language_id']; ?>][meta_keywords]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keywords'] : ''; ?>"/><input type='hidden' name="product_description[<?php echo $language['language_id']; ?>][meta_description]" value="<?echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?>"/>
						<tr>
