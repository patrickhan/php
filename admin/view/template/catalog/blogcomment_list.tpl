  ...
  <div class="content">
    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'pd.name') { ?>
              <a href="<?php echo $sort_product; ?>" class="<?php echo strtolower($order); ?>">Blog Post</a>
              <?php } else { ?>
              <a href="<?php echo $sort_product; ?>">Blog Post</a>
              <?php } ?></td>
        ...
        <tbody>
          <?php if ($blogcomments) { ?>
          <?php foreach ($blogcomments as $key => $review) { ?>
          <tr class="row" id="row<?php echo $key; ?>" >
            <td style="align: center;"><?php if ($review['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $review['blogcomment_id']; ?>" checked="checked" onclick="highlight(this, 'row<?php echo $key; ?>')" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $review['blogcomment_id']; ?>" onclick="highlight(this, 'row<?php echo $key; ?>')" />
              <?php } ?></td>
