  ...
  <div class="content">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="language<?php echo $language['language_id']; ?>">
        ...
        <input type='hidden' name="category_description[<?php echo $language['language_id']; ?>][meta_keywords]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_keywords'] : ''; ?>"/> <input type='hidden' name="category_description[<?php echo $language['language_id']; ?>][meta_description]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_description'] : ''; ?>"/>
