...
<div class="box">
	...
	<div class="content">
		<div id="tabs" class="tabs"><a tab="#tab_general"><?php echo $tab_general; ?></a><a tab="#tab_option"><?php echo $tab_option; ?></a><a tab="#tab_discount"><?php echo $tab_discount; ?></a><a tab="#tab_special"><?php echo $tab_special; ?></a></div>
			...
			<div id="tab_general">
				...
				<div id="language<?php echo $language['language_id']; ?>">
					<table class="form">
						...
						<tr>
							<td><?php echo $entry_meta_title_tag; ?></td>
							<td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_title_tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title_tag'] : ''; ?>" />
								<?php if (isset($error_meta_title_tag[$language['language_id']])) { ?>
								<span class="error"><?php echo $error_meta_title_tag[$language['language_id']]; ?></span>
								<?php } ?></td>
						</tr>
						<tr>
							<td><?php echo $entry_meta_keywords; ?></td>
							<td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_keywords]" cols="100" rows="1"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keywords'] : ''; ?></textarea></td>
						</tr>
						<tr>
							<td><?php echo $entry_meta_description; ?></td>
							<td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" cols="100" rows="1"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
						</tr>
						<tr>
...
<span>If an image you are using does not show up after being uploaded, open the image in a picture editor such as PhotoShop or Paint, convert it to an RGB Format and save it as a JPG or PNG</span></a></td>
				...
				<table class="form">
					...
					<tr>
						<td><?php echo $entry_gift_certificate; ?></td>
						<td><?php if ($gift_certificate) { ?>
							<input type="radio" name="gift_certificate" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="gift_certificate" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="gift_certificate" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="gift_certificate" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<?php } else { ?>
						<td><input disabled type="text" name="youtube" value="<?php echo $youtube; ?>" /><input type="hidden" name="youtube" value="" /></td>
						<?php } ?>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><div class="scrollbox">
								...
								<div class="<?php echo $class; ?>">
									<?php if (in_array($category['category_id'], $product_category) || $catid == $category['category_id']) { ?>
...
?>
		...
		<div id="tabs" class="btabs"><a tab="#tab_general"><?php echo $tab_general; ?></a><a tab="#tab_option"><?php echo $tab_option; ?></a><a tab="#tab_discount"><?php echo $tab_discount; ?></a><a tab="#tab_special"><?php echo $tab_special; ?></a></div>
	</div>
	<div class="fleft"></div>
...
<script type="text/javascript" src="view/javascript/ckeditor/ckeditor.js"></script><script type="text/javascript" src="view/javascript/ckfinder/ckfinder.js"></script>
<script type="text/javascript"><!--
<?php foreach ($languages as $language) { ?>
var editor = CKEDITOR.replace('description<?php echo $language['language_id']; ?>');    CKFinder.setupCKEditor( editor, '/admin/view/javascript/ckfinder/');
<?php } ?>
//--></script>
<script type="text/javascript"><!--
function addRelated() {
