		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div id="tab_shop">
				<table class="form">
					...
					<?php if ($this->config->get('brochure') === TRUE) { ?>
					<tr>
					...
					<tr>
						<td><span class="required">*</span> <?php echo $entry_serial; ?></td>
						<td><input type="text" name="config_serial" size="26" maxlength="20" value="<?php echo $config_serial; ?>" />
						<br/><em style="font-size: 90%; color: red;">Do not change this unless specified to do so. An incorrect serial will prevent your site from working.</em></td>
					</tr>
				</table>
				<br />
				...
				<div id="language<?php echo $language['language_id']; ?>">
					<table class="form">
						<tr>
							<td><?php echo $entry_order_message; ?></td>
							<td><textarea cols="40" rows="5" name="config_order_message_<?php echo $language['language_id']; ?>" id="order_message_<?php echo $language['language_id']; ?>"><?php echo ${'config_order_message_' . $language['language_id']}; ?></textarea></td>
						</tr>
					</table>
				</div>
				<?php } ?>
				...
				<table class="form">
					<tr>
						...
						<td><?php if ($config_alert_mail) { ?>
							...
							<?php echo $text_no; ?>
							<?php } ?></td>
					</tr><tr>						<td>Product Reviews:<br /><span class="help">Allow customers to leave reviews on your products.</span></td>						<td><?php if ($config_review) { ?>							<input type="radio" name="config_review" value="1" checked="checked" />							<?php echo $text_yes; ?>							<input type="radio" name="config_review" value="0" />							<?php echo $text_no; ?>							<?php } else { ?>							<input type="radio" name="config_review" value="1" />							<?php echo $text_yes; ?>							<input type="radio" name="config_review" value="0" checked="checked" />							<?php echo $text_no; ?>							<?php } ?></td>					</tr>					<tr>						<td>Profanity Filter:<br /><span class="help">Replaces profanity with asterisks. Separate with commas</span></td>						<td><textarea rows='6' cols='90' name='config_filter' id='config_filter'><?echo $config_filter;?></textarea></td>					</tr>
					<tr><td>Enable Filter On:</td><td>
					Quote Request<br>
					<?php if ($config_quote_filter) { ?>
							<input type="radio" name="config_quote_filter" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_quote_filter" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_quote_filter" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_quote_filter" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?>
					<br><br>
					Contact Us<br>
					<?php if ($config_contact_filter) { ?>
							<input type="radio" name="config_contact_filter" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_contact_filter" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_contact_filter" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_contact_filter" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?>
					<br><br>
					Comments and Reviews<br>
					<?php if ($config_review_filter) { ?>
							<input type="radio" name="config_review_filter" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_review_filter" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_review_filter" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_review_filter" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?>
					<br><br>
					Referral Email<br>
					<?php if ($config_refer_filter) { ?>
							<input type="radio" name="config_refer_filter" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_refer_filter" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_refer_filter" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_refer_filter" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?>
					</td></tr>
					<tr>						<td>Product Display:<br /><span class="help">Products will be displayed</span></td>						<td><?php if ($config_prods) { ?>							<input type="radio" name="config_prods" value="1" checked="checked" />							List							<input type="radio" name="config_prods" value="0" />							Tiles							<?php } else { ?>							<input type="radio" name="config_prods" value="1" />							List							<input type="radio" name="config_prods" value="0" checked="checked" />						Tiles			<?php } ?></td>					</tr>
					<tr>						<td>Category Display:<br /><span class="help">Display categories on front page</span></td>						<td><?php if ($config_cats) { ?>							<input type="radio" name="config_cats" value="1" checked="checked" />							Yes							<input type="radio" name="config_cats" value="0" />							No							<?php } else { ?>							<input type="radio" name="config_cats" value="1" />							Yes							<input type="radio" name="config_cats" value="0" checked="checked" />						No			<?php } ?></td>					</tr>
					<tr>
						<td>Reviews:<br /><span class="help">Allow customers to review products</span></td>
						<td><?php if ($config_show_reviews) { ?>
							<input type="radio" name="config_show_reviews" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_show_reviews" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_show_reviews" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_show_reviews" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php if ($config_display_featured) { ?>
							<input type="radio" name="config_display_featured" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_display_featured" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_display_featured" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_display_featured" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?></td>
					</tr>
					<tr>
						<td><?php echo $entry_display_new; ?></td>
						<td><?php if ($config_display_new) { ?>
							<input type="radio" name="config_display_new" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_display_new" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_display_new" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_display_new" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?></td>
					</tr>
					<tr>
						<td><?php echo $entry_display_specials; ?></td>
						<td><?php if ($config_display_specials) { ?>
							<input type="radio" name="config_display_specials" value="1" checked="checked" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_display_specials" value="0" />
							<?php echo $text_no; ?>
							<?php } else { ?>
							<input type="radio" name="config_display_specials" value="1" />
							<?php echo $text_yes; ?>
							<input type="radio" name="config_display_specials" value="0" checked="checked" />
							<?php echo $text_no; ?>
							<?php } ?></td>
					</tr>
				</table>
			...
			<div id="tab_image">
				<table class="form">
					...
					<tr>
						<td><?php echo $entry_admin_logo; ?></td>
						<td><input type="hidden" name="config_admin_logo" value="<?php echo $config_admin_logo; ?>" id="config_admin_logo" />
							<img src="<?php echo $preview_admin_logo; ?>" alt="" id="preview_admin_logo" style="border: 1px solid #EEEEEE;" />&nbsp;<img src="view/image/image.png" alt="" style="cursor: pointer;" align="top" onclick="image_upload('config_admin_logo', 'preview_admin_logo');" /></td>
					</tr>
					<tr>
