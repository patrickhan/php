<?php
class ControllerModulemymodule3 extends Controller {
	private $error = array();
	private $_name = 'mymodule3';
	...
	public function index() {   
		...
		$this->data['mymodule3_version'] = $this->_version;
		...
		$this->document->breadcrumbs[] = array(
			'href'      => HTTPS_SERVER . 'index.php?route=module/mymodule3',
			'text'      => $this->language->get('heading_title'),
			'separator' => ' :: '
		);
		
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/mymodule3';
		...
		if (isset($this->request->post[$this->_name . '_code'])) {
			$this->data[$this->_name . 'mymodule3_code'] = $this->request->post[$this->_name . '_code'];
		} else {
