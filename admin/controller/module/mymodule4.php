<?php
class ControllerModulemymodule4 extends Controller {
	private $error = array();
	private $_name = 'mymodule4';
	...
	public function index() {   
		...
		$this->data['mymodule4_version'] = $this->_version;
		...
		$this->document->breadcrumbs[] = array(
			'href'      => HTTPS_SERVER . 'index.php?route=module/mymodule4',
			'text'      => $this->language->get('heading_title'),
			'separator' => ' :: '
		);
		
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/mymodule4';
		...
		if (isset($this->request->post[$this->_name . '_code'])) {
			$this->data[$this->_name . 'mymodule4_code'] = $this->request->post[$this->_name . '_code'];
		} else {
