<?php
//       *******************************************************
//       *  To add extra modules with the same code please     *
//       *  Follow these instructions...                       *
//       *  1. add a "_1" to the end of all the files name     *
//       *  E.g mymodule_1                                     * 
//       *  open the files and serch for mymodule change this  *
//       *  to mymodule_1 or what ever you named it.           *
//       *  3. Make sure you change all the files name and all *
//       *  the mymodule in the files.                         *
//       *  4. Upload the files and go into the admin area     *
//       *  and you should see a extra module named mymodule_1 *
//       *                                                     *
//       *        Thank you for downloading this module        *
//       *           Copyright Nats Bargains 2010              *
//       *                                                     *
//       *                                                     *
//       *    If you have any trouble please email             *
//       *        sales@nats-bargains.co.uk                    *
//       *                                                     *
//        *****************************************************
?>
<?php
class ControllerModuleMyModule extends Controller {
	...
	public function index() {   
		...
		$this->document->breadcrumbs[] = array(
			'href'      => HTTPS_SERVER . 'index.php?route=module/mymodule',
			'text'      => $this->language->get('heading_title'),
			'separator' => ' :: '
		);
		
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/mymodule';
