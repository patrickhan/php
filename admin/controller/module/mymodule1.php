...
class ControllerModuleMyModule1 extends Controller {
	...
	public function index() {   
		...
		$this->data['mymodule1_version'] = $this->_version;
		...
		$this->document->breadcrumbs[] = array(
			'href'      => HTTPS_SERVER . 'index.php?route=module/mymodule1',
			'text'      => $this->language->get('heading_title'),
			'separator' => ' :: '
		);
		
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/mymodule1';
		...
		if (isset($this->request->post[$this->_name . '_code'])) {
			$this->data[$this->_name . 'mymodule1_code'] = $this->request->post[$this->_name . '_code'];
		} else {
