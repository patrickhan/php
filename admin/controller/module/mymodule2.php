...
class ControllerModuleMyModule2 extends Controller {
	...
	public function index() {   
		...
		$this->data['mymodule2_version'] = $this->_version;
		...
		$this->document->breadcrumbs[] = array(
			'href'      => HTTPS_SERVER . 'index.php?route=module/mymodule2',
			'text'      => $this->language->get('heading_title'),
			'separator' => ' :: '
		);
		
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/mymodule2';
		...
		if (isset($this->request->post[$this->_name . '_code'])) {
			$this->data[$this->_name . 'mymodule2_code'] = $this->request->post[$this->_name . '_code'];
		} else {
