...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$filt = explode(',', $this->request->post['config_filter']);
			//print_r($filt); die;
			$num = 0;
			$xml = "<?php
\$badwords = array(";
...
$file = fopen("filter/wordlist-regex.php", 'w');
fwrite($file, $xml);
...
fclose($file);
		...
		$this->data['entry_serial'] = $this->language->get('entry_serial');
		...
		$this->data['entry_admin_logo'] = $this->language->get('entry_admin_logo');
		...
		$this->data['entry_display_featured'] = $this->language->get('entry_display_featured');
		$this->data['entry_display_new'] = $this->language->get('entry_display_new');
		$this->data['entry_display_specials'] = $this->language->get('entry_display_specials');
		...
		include('filter/wordlist-regex.php');
		//print_r($badwords); die;
		if (isset($this->request->post['config_filter'])) {
			$this->data['config_filter'] = $this->request->post['config_filter'];
		} else {
			$this->data['config_filter'] = implode(',',$badwords); //$this->config->get('config_filter');
		}
		
		if (isset($this->request->post['config_prods'])) {
			$this->data['config_prods'] = $this->request->post['config_prods'];
		} else {
			$this->data['config_prods'] =  $this->config->get('config_prods');;
		}
		
		if (isset($this->request->post['config_cats'])) {
			$this->data['config_cats'] = $this->request->post['config_cats'];
		} else {
		...
		if (isset($this->request->post['config_quote_filter'])) {
			$this->data['config_quote_filter'] = $this->request->post['config_quote_filter'];
		} else {
			$this->data['config_quote_filter'] = $this->config->get('config_quote_filter');
		}
		
		if (isset($this->request->post['config_contact_filter'])) {
			$this->data['config_contact_filter'] = $this->request->post['config_contact_filter'];
		} else {
			$this->data['config_contact_filter'] = $this->config->get('config_contact_filter');
		}
		
		if (isset($this->request->post['config_refer_filter'])) {
			$this->data['config_refer_filter'] = $this->request->post['config_refer_filter'];
		} else {
			$this->data['config_refer_filter'] = $this->config->get('config_refer_filter');
		}
		
		if (isset($this->request->post['config_show_reviews'])) {
			$this->data['config_show_reviews'] = $this->request->post['config_show_reviews'];
		} else {
			$this->data['config_show_reviews'] = $this->config->get('config_show_reviews');
		}
		
		if (isset($this->request->post['config_review_filter'])) {
			$this->data['config_review_filter'] = $this->request->post['config_review_filter'];
		} else {
			$this->data['config_review_filter'] = $this->config->get('config_review_filter');
		}
		...
		if (isset($this->request->post['config_serial'])) {
			$this->data['config_serial'] = $this->request->post['config_serial'];
		} else {
			$this->data['config_serial'] = $this->config->get('config_serial');
		}
		...
		foreach ($directories as $directory) {
			//print_r(basename($directory));
			if(basename($directory) != 'not_display'){
		...
		if (isset($this->request->post['config_display_featured'])) {
			$this->data['config_display_featured'] = $this->request->post['config_display_featured'];
		} else {
			$this->data['config_display_featured'] = $this->config->get('config_display_featured');
		}
		
		if (isset($this->request->post['config_display_new'])) {
			$this->data['config_display_new'] = $this->request->post['config_display_new'];
		} else {
			$this->data['config_display_new'] = $this->config->get('config_display_new');
		}
		
		if (isset($this->request->post['config_display_specials'])) {
			$this->data['config_display_specials'] = $this->request->post['config_display_specials'];
		} else {
			$this->data['config_display_specials'] = $this->config->get('config_display_specials');
		}
		...
		$this->data['config_admin_logo'] = $this->config->get('config_admin_logo');
		
		if ($this->config->get('config_admin_logo') && file_exists(DIR_IMAGE . $this->config->get('config_admin_logo'))) {
			if ((isset($this->request->server['HTTPS'])) && ($this->request->server['HTTPS'] == 'on')) {
				$this->data['preview_admin_logo'] = HTTPS_IMAGE . $this->config->get('config_admin_logo');
			} else {
				$this->data['preview_admin_logo'] = HTTP_IMAGE . $this->config->get('config_admin_logo');
			}
		} else {
			$this->data['preview_admin_logo'] = image_resize('no_image.jpg', 100, 100);
		}
	...
	private function validate() {
		...
		if ((strlen(utf8_decode($this->request->post['config_email'])) > 64) || (!preg_match($pattern, $this->request->post['config_email']))) {
