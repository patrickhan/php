...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_site_manager'] = $this->language->get('text_site_manager');
		...
		$this->data['text_newsletter_signups'] = $this->language->get('text_newsletter_signups');
		...
		$this->data['text_headers'] = $this->language->get('text_headers');
		...
		$this->data['links'] = $this->url->https('extension/links');
		$this->data['banners'] = $this->url->https('extension/banners');
		$this->data['geo_zone'] = $this->url->https('localisation/geo_zone');
		$this->data['home'] = $this->url->https('common/home'); 
		$this->data['information'] = $this->url->https('catalog/information');				$this->data['articles'] = $this->url->https('catalog/articles');
		$this->data['menu'] = $this->url->https('catalog/menu');
		...
		$this->data['featured'] = $this->url->https('catalog/featured');
		$this->data['newsletter_signups'] = $this->url->https('sale/newsletter');
		$this->data['banner_statistics'] = $this->url->https('report/banners');
		$this->data['gallery_album'] = $this->url->https('catalog/gallery_album');
		$this->data['gallery_image'] = $this->url->https('catalog/gallery_image');
		$this->data['generate_sitemap'] = $this->url->https('tool/generate_sitemap');
		$this->data['headers'] = $this->url->https('extension/header_image');
		$this->data['images'] = $this->url->https('extension/image_delete');
