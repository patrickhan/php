<?php
class ControllerExtension411 extends Controller {
	public function index() {
		$this->load->language('extension/total');
		 
		$this->document->title = '411.ca';
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => $this->url->https('extension/411'),
       		'text'      => '411.ca',
      		'separator' => ' :: '
   		);
		
		$this->data['heading_title'] = '411';
		...
		$this->template = 'extension/411.tpl';
		$this->children = array(
			'common/header',	
			'common/footer'	
		);
