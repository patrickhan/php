...
var slideshowFadeUrl  = new Array();

var slideshowFadeImages  = new Array();

var slideshowFadeText  = new Array();
...
function slideshowFade(id,cl,imageArray,textArray,fadeInterval,holdTime,width,height)

{
  ...
  document.write('<a target="_blank" id="'+id+'link"><img width="'+width+'px" height="'+height+'px" id="'+id+'img" onload="slideshowFadeRun(\''+id+'\')"/></a>');

  //document.write('<a id="'+id+'link"><img width="'+width+'px" height="'+height+'px" id="'+id+'img" onload="slideshowFadeRun(\''+id+'\')"/></a>');
...

{
...

  {
	...
	var obj2 = document.getElementById(id + 'link');
...

    {
      ...
      obj2.href = slideshowFadeUrl[id][Math.floor(slideshowFadeCount[id]/200)%slideshowFadeImages[id].length];
