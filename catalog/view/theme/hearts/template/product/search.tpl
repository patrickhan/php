...
<div id="content">
  ...
  <div class="middle"><b><?php echo $text_critea; ?></b>
    <div id="content_search" class="light" style="padding: 10px; margin-top: 3px; margin-bottom: 10px;">
      <table>
        <tr>
    ...
    <?php } else { ?>
    <div class="light" style="padding: 10px; margin-top: 3px; margin-bottom: 15px;"><?php echo $text_empty; ?></div>
    <?php }?>
  </div>
  <div class="bottom">
    <div class="left"></div>
