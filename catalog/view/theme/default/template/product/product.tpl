...
<div id="content">
	...
	<div class="middle">
				...
				<tr>
					...
					<td style="padding-left: 15px; width: 296px; vertical-align: top;"><table width="100%">
						...
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="product">
							...
							<div class="light" style="padding: 10px; margin-top: 2px; margin-bottom: 15px;">
								<table style="width: 100%;">
									<tr>
							...
							<?php } ?>
							<?php } ?>
							<div class="light" style="padding: 10px;"><?php echo $text_qty; ?>
						...
						<div style="padding: 10px; text-align: center;">
							<a style="text-decoration: none;" href="<?php echo $continue; ?>" class="button"><span><?php echo $button_continue_shopping; ?></span></a>
							<a style="text-decoration: none;" href="<?php echo $checkout; ?>" class="button"><span><?php echo $button_checkout; ?></span></a>
						</div>
						<?php } ?></td>
				</tr>
			</table>
		</div>
		<div class="tabs"><a tab="#tab_description"><?php echo $tab_description; ?></a><a tab="#tab_image"><?php echo $tab_image; ?></a><?if ($this->config->get('config_show_reviews')) {?><a tab="#tab_review"><?php echo $tab_review; ?></a><?}?><a tab="#tab_related"><?php echo $tab_related; ?></a></div>
		<div id="tab_description" class="tab_page">
			<?php echo $description; ?>
			<?php if ($youtube) { ?>
			<?php echo '<object width="480" height="385"><param name="movie" value="http://www.youtube.com/v/' . $youtube . '&hl=en_US&fs=1&"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/' . $youtube . '&hl=en_US&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="480" height="385"></embed></object>'; ?>
			<?php } ?>
		</div>
		<?if ($this->config->get('config_show_reviews')) {?><div id="tab_review" class="tab_page">
			<div id="review"></div>
			<div class="heading" id="review_title"><?php echo $text_write; ?></div>
			<div class="light" style="padding: 10px; margin-bottom: 10px;"><b><?php echo $entry_name; ?></b><br />
				...
				<br />
				<b><?php echo $entry_captcha; ?></b><br />						<input type='text' id='cap1' name='cap1'/><br><div style='font-weight:bold;font-size:150%;' name='cap2' id='cap2'></div>
			</div>
			<div class="buttons">
				<table>
					<tr>
		...
		<div id="tab_image" class="tab_page">
			...
			<?php } else { ?>
			<div class="light" style="padding: 10px; margin-bottom: 10px;"><?php echo $text_no_images; ?></div>
			<?php } ?>
		</div>
		<div id="tab_related" class="tab_page">
			...
			<?php } else { ?>
			<div class="light" style="padding: 10px; margin-bottom: 10px;"><?php echo $text_no_related; ?></div>
			<?php } ?>
		</div>
	</div>
	<div class="bottom">
