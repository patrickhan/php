...
<div id="content">
  ...
  <div class="middle">
    ...
    <div style="width: 558px; display: inline-block;">
      ...
      <?php if ($show_points) { ?>
	  <div style="float: left; width: 279px;">
        <div style="border: 1px solid #DDDDDD; min-height: 125px; margin-left: 10px;">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="points">
            <div style="background: #F7F7F7 url('catalog/view/theme/default/image/points.png') 8px 8px no-repeat; border-bottom: 1px solid #DDDDDD; padding: 8px 8px 8px 29px;"><span style="text-transform: uppercase; font-size: 14px; font-weight: bold;"><?php echo $text_points; ?></span></div>
            <div style="padding: 8px;"><?php echo $text_point; ?><br />
              <input type="checkbox" name="points" value="1" />
              <a onclick="$('#points').submit();" class="button"><span><?php echo $button_points; ?></span></a></div>
          </form>
        </div>
      </div>
      <?php } ?>
