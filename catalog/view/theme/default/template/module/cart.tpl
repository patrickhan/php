	...
	<div class="middle">
		...
		<table cellpadding="2" cellspacing="0" style="width: 100%;">
			...
			<tr>
				...
				<td valign="top"><a href="<?php echo $product['href']; ?>"><?php echo ( ! empty($product['image'])) ? '<img src="' . $product['image'] . '">' : ''; ?></a></td>
			</tr>
			<?php } ?>
		</table>
		<br />
		...
		<br />
		<div style="text-align: center;"><a style="text-decoration: none;" href="<?php echo $checkout; ?>" class="button"><span><?php echo $button_checkout; ?></span></a></div>
		<?php } else { ?>
