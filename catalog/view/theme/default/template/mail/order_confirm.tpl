...
<table style="font-family: Verdana,sans-serif; font-size: 11px; color: #374953; width: 600px;">
  ...
  <?php } ?>
  <tr>
    <td align="center" style="font-size: 10px; border-top: 1px solid #D9DADE;"><a href="<?php echo $website; ?>" style="color: #069; font-weight: bold; text-decoration: none;"><?php echo $store; ?></a> <?php echo $text_powered_by; ?> <a href="http://www.jsiwebtools.com" style="text-decoration: none; color: #374953;">JSI Web Tools</a></td>
  </tr>
</table>
</body>
</html>
