...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if (isset($this->request->post['points'])) {
				if ($this->validate_points()) {
					$this->session->data['points'] = $this->request->post['points'];
					
					$this->session->data['success'] = $this->language->get('text_success_points');
		...
		if ($this->customer->isLogged()) {
			...
			if ($this->config->get('points_status') && $customer['points'] > 0) {
				$this->data['show_points'] = TRUE;
				$this->data['text_point'] = sprintf($this->language->get('text_point'), $customer['points']);
			}
		}
		...
		if ($this->cart->hasProducts()) {
			...
			$this->data['button_points'] = $this->language->get('button_points');
	...
	private function validate_points() {
