...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['upper'])) {
			$url .= '&upper=' . $this->request->get['upper'];
		}
		
		if (isset($this->request->get['lower'])) {
			$url .= '&lower=' . $this->request->get['lower'];
		}
		...
		if (isset($this->request->get['upper'])) {
			$this->data['upper'] = $this->request->get['upper'];
		} else {
			$this->data['upper'] = '';
		}
				
		if (isset($this->request->get['lower'])) {
			$this->data['lower'] = $this->request->get['lower'];
		} else {
			$this->data['lower'] = '';
		}
		...
		if ((isset($this->request->get['upper'])) || (isset($this->request->get['lower']))) {
			$this->load->model('catalog/product');
			
			$product_total = $this->model_catalog_product->getTotalProductsByPrice(isset($this->request->get['category_id']) ? $this->request->get['category_id'] : '', isset($this->request->get['description']) ? $this->request->get['description'] : '', isset($this->request->get['lower']) ? $this->request->get['lower'] : '', isset($this->request->get['upper']) ? $this->request->get['upper'] : '');
			...
			if ($product_total) {
				...
				$results = $this->model_catalog_product->getProductsByPrice(isset($this->request->get['category_id']) ? $this->request->get['category_id'] : '', isset($this->request->get['description']) ? $this->request->get['description'] : '', $sort, $order, ($page - 1) * 12, 127, isset($this->request->get['lower']) ? $this->request->get['lower'] : '', isset($this->request->get['upper']) ? $this->request->get['upper'] : '');
