...
class ControllerAccountCreate extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$sendto = array($this->request->post['email']);
			...
			$sendto = array($this->config->get('config_email'));
			
			$message_admin = "A user, " . $this->db->escape($this->request->post['firstname']) . " " . $this->db->escape($this->request->post['lastname']) . ", with the e-mail address " . $this->request->post['email'] . " has registered with " . $this->config->get('config_store') . " on " . date('r');
			
			$mail = new Mail($this->config->get('config_mail_protocol'), $this->config->get('config_smtp_host'), $this->config->get('config_smtp_username'), html_entity_decode($this->config->get('config_smtp_password')), $this->config->get('config_smtp_port'), $this->config->get('config_smtp_timeout'));
			$mail->setTo($sendto);
			$mail->setFrom($this->config->get('config_email'));
			$mail->setSender($this->config->get('config_store'));
			$mail->setSubject($this->config->get('config_store'));
